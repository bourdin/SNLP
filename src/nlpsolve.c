...
//      option.printFunctionGradient = NO;
//      option.printConstraintGradient = NO;
//      option.simpleLineSearch = NO;
//
// Function output:
//
...
NLPsolve(double (*fhg) (Vector x, Vector h, Vector g, void *ctx),
    ...
    if (options.method == L1SQPmethod) {
        ...
        sqp0->printFunctionGradient = options.printFunctionGradient;
        sqp0->printConstraintGradient = options.printConstraintGradient;
        sqp0->simpleLineSearch = options.simpleLineSearch;
        ...
        sqp1->printFunctionGradient = options.printFunctionGradient;
        sqp1->printConstraintGradient = options.printConstraintGradient;
        sqp1->simpleLineSearch = options.simpleLineSearch;
